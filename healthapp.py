...
input_prompt="""
You are an expert in nutritionist where you need to see the food  items from image and calculate the total calories , also provide the details of every food items with calories intake in below formate
